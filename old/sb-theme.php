...
/** Khai báo đường dẫn đến thư mục sb-theme cũ */
define( 'SB_THEME_PATH', untrailingslashit(get_template_directory()) . '/sb-theme/old' );

/** Khai báo đường dẫn đến thư mục sb-theme cũ */
define( 'SB_THEME_URL', untrailingslashit(get_template_directory_uri()) . '/sb-theme/old' );

/** Khai báo đường dẫn đến thư mục sb-theme */
define( 'SB_THEME_NEW_PATH', untrailingslashit(get_template_directory()) . '/sb-theme' );

/** Khai báo đường dẫn đến thư mục sb-theme */
define( 'SB_THEME_NEW_URL', untrailingslashit(get_template_directory_uri()) . '/sb-theme' );
